...
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,16;NOP;NOP;JR,X2,39;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,16;NOP;NOP;JR,X2,39;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,17;NOP;NOP;JR,X2,41;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,17;NOP;NOP;JR,X2,41;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,18;NOP;NOP;JR,X2,43;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,18;NOP;NOP;JR,X2,43;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,19;NOP;NOP;JR,X2,45;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,19;NOP;NOP;JR,X2,45;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,20;NOP;NOP;JR,X2,47;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,20;NOP;NOP;JR,X2,47;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,21;NOP;NOP;JR,X2,49;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,21;NOP;NOP;JR,X2,49;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,22;NOP;NOP;JR,X2,51;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,22;NOP;NOP;JR,X2,51;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,23;NOP;NOP;JR,X2,53;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,23;NOP;NOP;JR,X2,53;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,24;NOP;NOP;JR,X2,55;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,24;NOP;NOP;JR,X2,55;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,25;NOP;NOP;JR,X2,57;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,25;NOP;NOP;JR,X2,57;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,26;NOP;NOP;JR,X2,59;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,26;NOP;NOP;JR,X2,59;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,27;NOP;NOP;JR,X2,61;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,27;NOP;NOP;JR,X2,61;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,28;NOP;NOP;JR,X2,63;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,28;NOP;NOP;JR,X2,63;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,29;NOP;NOP;JR,X2,65;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,29;NOP;NOP;JR,X2,65;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,30;NOP;NOP;JR,X2,67;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,30;NOP;NOP;JR,X2,67;#
ADDi,R0,0,0,R1,0,2,0;ADDi,R21,0,1,R20,0,1,0;MATCH,R20,X0,31;NOP;NOP;JR,X2,69;#
ADDi,R0,0,0,R1,0,2,0;NOP;MATCH,R20,X0,31;NOP;NOP;JR,X2,69;#
