...
${COMPILER_DIR}/build/bin/clang++ -mllvm -debug -emit-llvm -S --target=primate32-linux-gnu -march=pr32i -mllvm -print-after-all -O3 "${TARGET}.cpp" -o "${TARGET}.ll" 2> front-end.log
